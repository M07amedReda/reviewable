...
namespace MohamedReda\Reviewable\Tests;
...
class ReviewableTest extends TestCase
{
    ...
    /** @test */
    public function it_can_review_models()
    {
    ...
    /** @test */
    public function it_can_get_reviewed_by_loged_in_users()
    {
    ...
    /** @test */
    public function it_can_get_the_total_score_of_all_reviews()
    {
        review($this->userToReview, 10, '', $this->testUser);
    ...
    /** @test */
    public function it_can_get_the_average_score_of_all_reviews()
    {
        review($this->userToReview, 10, '', $this->testUser);
        review($this->userToReview, 1, '', $this->testUser);
        review($this->userToReview, 5, '', $this->testUser);
